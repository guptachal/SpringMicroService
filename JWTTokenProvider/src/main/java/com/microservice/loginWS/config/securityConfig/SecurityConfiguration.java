        ...
        try{
            ...
            http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                    ...
                    .authorizeHttpRequests((request)->
                            request.requestMatchers(AppConstants.PUBLIC_URLS).permitAll()
                                    .requestMatchers(AppConstants.PROTECTED_COMMON_URLS).authenticated()
                                    .requestMatchers(AppConstants.ADMIN_ACCESS_URLS).hasRole("ADMIN")
                                    .requestMatchers(AppConstants.USER_ACCESS_URLS).hasAnyRole("USER")
